@echo off
@echo Compilando...
g++ -c wrapper.cpp -o wrapper.o -I"C:\mingw64\include" -I"C:\mingw64\x86_64-w64-mingw32\include" -I"..\src" -I"..\src\bullet" -I"%JAVA_HOME%\include" -I"%JAVA_HOME%\include\win32" -m64 -DBUILDING_DLL=1
