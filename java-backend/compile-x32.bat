@echo off
@echo Compilando...
g++ -c wrapper.cpp -o wrapper.o -I"C:\mingw64\include" -I"C:\mingw64\x86_64-w64-mingw32\include" -I"..\src" -I"..\src\bullet" -I"C:\Program Files\Java\jdk-11.0.13\include" -I"C:\Program Files\Java\jdk-11.0.13\include\win32" -m32 -DBUILDING_DLL=1
