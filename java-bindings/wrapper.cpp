...
extern "C" {
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plDynamicWorldfv(JNIEnv* env, jobject thiz,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plDynamicWorldfv(param,cval,length);
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plGetDynamicWorldiv(JNIEnv* env, jobject thiz,jint param,jintArray val,jint length) {
		int* cval = (int*)env->GetPrimitiveArrayCritical(val,0);
		plGetDynamicWorldiv(param,cval,length);
		env->ReleasePrimitiveArrayCritical(val,cval,0);
	}
	
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plGetDynamicWorldfv(JNIEnv* env, jobject thiz,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plGetDynamicWorldfv(param,cval,length);
		env->ReleasePrimitiveArrayCritical(val, cval, 0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plShapefv(JNIEnv* env, jobject thiz,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plShapefv(param,cval,length);
		env->ReleasePrimitiveArrayCritical(val,cval,0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plGetShapefv(JNIEnv* env, jobject thiz,jint idx,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plGetShapefv(idx,param,cval,length);
		env->ReleasePrimitiveArrayCritical(val, cval, 0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plBufferData(JNIEnv* env, jobject thiz,jint type, jint size, jobject data) {
		...
		// JVM garbage collector frees the buffer after this call
		plBufferData(type, size, env->GetDirectBufferAddress(data), PL_TRUE);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plRigidBodyfv(JNIEnv* env, jobject thiz,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plRigidBodyfv(param, cval, length);
		env->ReleasePrimitiveArrayCritical(val, cval, 0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plGetRigidBodyfv(JNIEnv* env, jobject thiz,jint idx,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plGetRigidBodyfv(idx,param,cval,length);
		env->ReleasePrimitiveArrayCritical(val,cval,0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plConstraintfv(JNIEnv* env, jobject thiz,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plConstraintfv(param,cval,length);
		env->ReleasePrimitiveArrayCritical(val,cval,0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plVehiclefv(JNIEnv* env, jobject thiz, jint param, jfloatArray val, jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plVehiclefv(param, cval, length);
		env->ReleasePrimitiveArrayCritical(val, cval, 0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plGetWheelfv(JNIEnv* env, jobject thiz,jint wheel, jint param, jfloatArray val, jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val, 0);
		plGetWheelfv(wheel, param, cval, length);
		env->ReleasePrimitiveArrayCritical(val, cval, 0);
	}
	...
	JNIEXPORT void JNICALL Java_com_openpl_PL10_plGetCharacterfv(JNIEnv* env, jobject thiz,jint chr,jint param,jfloatArray val,jint length) {
		float* cval = (float*)env->GetPrimitiveArrayCritical(val,0);
		plGetCharacterfv(chr,param,cval,length);
		env->ReleasePrimitiveArrayCritical(val,cval,0);
	}
}
